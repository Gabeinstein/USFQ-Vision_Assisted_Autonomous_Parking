...
%%% Codigo para obtener perfiles de velocidad angular y lineal de la
%%% trayectoria deseada de parqueo. El resultado se exporta en formato .mat
%%% para procesarlo reproducirlo en el robot mediante ROS.

%%% Data
%%% MOV CIRCULAR -> [radio de curvatura, angulo, sentido, ICCx, ICCy]
%%% MOV LINEAL -> [radio de curvatura (inf) , distancia lineal, sentido, 0, 0]
...
puntos = [0,0; 0.383,0; 0.183, 0; 0,-0.165; 0,-0.1584-0.193];
...
data = [inf,0.382,1,0,0; inf,0.2,-1,0,0; sqrt((0.2528-0.182)^2 + (-0.272)^2),0.9,-1,0.2528,-0.272;0,0.6708,1,-0.0043,-0.1584; inf,0.193,-1,0,0];
